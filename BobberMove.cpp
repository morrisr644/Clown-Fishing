...
void BobberMove::Update(float deltaTime)
{
	...
	if (bobberPosition.z <= -100.0 && bobberPosition.y < 1450.0 && bobberPosition.y > -1450.0 && bobberPosition.x < 1450.0 && bobberPosition.x > -1450.0) // need to restrict this to the pond x and y as well.
	{
		bobber->PutInWater();
		bobber->HitGround();
	}
